              ...
              <div className="flex gap-3 p-4 overflow-x-auto bg-slate-50">
                {gallery.map((imgUrl, index) => (
                  <button
                    ...
                    className={`relative w-20 h-16 flex-shrink-0 rounded-xl overflow-hidden border-2 transition cursor-pointer ${
                      currentImage === imgUrl ? 'border-blue-600 shadow-md scale-105' : 'border-transparent opacity-70 hover:opacity-100'
                    }`}
                  >
